package com.example.habits.feature_habits.habits.screencomponents
...
import com.example.habits.feature_habits.habits.CalendarItemUi
...
fun CalendarItem(
    ...
    val backgroundColor =
        if (isSelected) colorResource(R.color.orange) else Color.Transparent
