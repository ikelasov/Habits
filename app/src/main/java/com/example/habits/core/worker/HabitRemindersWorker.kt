...
import com.example.habits.core.worker.utils.HABIT_REMINDER_CHANNEL_ID
import com.example.habits.core.worker.utils.HABIT_REMINDER_CHANNEL_NAME
...
class HabitRemindersWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            ...
            val inputData = Data.Builder().putString(INPUT_DATA_HABIT_ID, habitId).build()
            val request =
